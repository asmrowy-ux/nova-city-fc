...
export default async function Home() {
  const [posts, settings, sponsors] = await Promise.all([
    ...
    client.fetch(`*[_type == "siteSettings"][0]{ title, logo { asset { _ref } }, heroDescription, footerDescription, syncHeroWithFooter }`),
  ...
  return (
    <main className="flex min-h-screen flex-col bg-[#0a0a0a]">
      <Navbar />
      <HeroSection clubName={clubName} logoRef={logoRef} description={description} />
